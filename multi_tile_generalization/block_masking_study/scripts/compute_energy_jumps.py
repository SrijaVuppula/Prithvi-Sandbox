...
IN_CSV  = "multi_tile_generalization/block_masking_study/outputs/inference_energy.csv"
OUT_RB  = "multi_tile_generalization/block_masking_study/outputs/energy_jumps_random_vs_block.csv"
OUT_STEP = "multi_tile_generalization/block_masking_study/outputs/energy_jumps_ratio_steps.csv"
...
print("=== Random vs Block jump per backbone x ratio ===")
print(piv.to_string(index=False))
print("\n=== Ratio-step jump per backbone x mask_type ===")
